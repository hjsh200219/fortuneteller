#!/usr/bin/env python3
"""24절기 테이블 생성 — JPL DE440s 천체력(skyfield) 기반.

태양 겉보기 황경을 J2000 황도 좌표계(`frame_latlon(ecliptic_frame)`)로 구해
...
DE440s 범위(1849-2150) 때문에 1900-2149 만 생성한다. 1900년 1월 초(소한 이전)를 덮기 위해
...
START, END = 1900, 2149
OUT = Path(__file__).resolve().parent.parent / 'src/data/solar_terms_1900_2149.ts'
...
lines = [
    '/**',
    ' * 24절기 테이블 (1899 대설·동지·소한 + 1900-2149) — 자동 생성, 수동 편집 금지',
    ' * 생성: scripts/generate_solar_terms_skyfield.py (JPL DE440s, J2000 황도 좌표계)',
    ' * 연도 규약: year=Y 는 Y년 1월 대한 ~ Y+1년 1월 소한 (24개)',
    ' */',
    '',
    "import type { SolarTermComplete } from './solar_terms_1900_2019.js';",
    '',
    'export const SOLAR_TERMS_1900_2149: SolarTermComplete[] = [',
]
